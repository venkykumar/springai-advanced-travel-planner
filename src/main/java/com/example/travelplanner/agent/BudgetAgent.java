...
public class BudgetAgent {
    ...
    public BudgetAgent(BudgetTools budgetTools) {
    ...
    public BudgetBreakdown calculateBudget(String destination, int travelers, int nights,
        ...
        return budgetTools.calculateInternal(destination, travelers, nights, totalBudgetUSD, travelMonth, null);
    }
    ...
    public BudgetBreakdown recalculateForTier(String destination, int travelers, int nights,
        ...
        return budgetTools.calculateInternal(destination, travelers, nights, totalBudgetUSD, travelMonth, tier);
    }
}
